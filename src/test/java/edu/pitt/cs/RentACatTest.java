...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		assertNull("getCat(2) didn't return null when there were 0 cats", r.getCat(2));
	}
	...
	public void testGetCatNumCats3() {
		...
		assertNotNull("returnedCat should not be null when there are 3 cats", returnedCat);

		assertEquals("returnedCat's ID is not 2", 2, returnedCat.getId());
	}
	...
	public void testListCatsNumCats0() {
		// TODO
		assertEquals("listCats() did not return \"\"", "", r.listCats());
	}
	...
	public void testListCatsNumCats3() {
		...
		assertEquals("Return value did not match", "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", r.listCats());
	}
	...
	public void testRentCatFailureNumCats0() {
		// TODO
		assertFalse("rentCat(2) did not return false!", r.rentCat(2));
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		assertFalse("Return value was true!", r.rentCat(2));
